...
public class CustomTraderTemplate implements ModCreature {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder trader = new CreatureTemplateBuilder(
                "mod.creature.customtrader",
                "custom trader",
                "An envoy from the king, buying and selling authorised items.",
    ...
    public static Creature createNewTrader(VolaTile tile, int floorLevel, String name, byte sex, byte kingdom, String tag) throws Exception {
        ...
        CustomTraderDatabase.addNew(trader, tag);
