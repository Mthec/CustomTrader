...
public class CurrencyTraderTemplate implements ModCreature {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder trader = new CreatureTemplateBuilder(
                "mod.creature.currencytrader",
                "currency trader",
                "An envoy from the king, selling authorised items in exchange for a specified currency.",
    ...
    public static boolean isCurrencyTrader(Creature creature) {
        return creature.getTemplateId() == templateId;
    }

    public static boolean isCurrencyTrader(CreatureTemplate template) {
    ...
    public static Creature createNewTrader(VolaTile tile, int floorLevel, String name, byte sex, byte kingdom, int currency, String tag) throws Exception {
        ...
        CustomTraderDatabase.addNew(trader, currency, tag);
