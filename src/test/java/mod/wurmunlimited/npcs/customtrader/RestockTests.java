...
public class RestockTests extends CustomTraderTest {
    ...
    void testItemAddedIfListedUnique() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], num, num, num);
        CustomTraderDatabase.restock(trader);
    ...
    void testMixedNumberOfItemsToRestock() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], 10, num, 0);
        CustomTraderDatabase.addStockItemTo(trader, num + 1, num, num, b, b, num, new Enchantment[0], 7, num, 0);
    ...
    void testItemsRestockedAtProperRate() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], num, 1, 0);
    ...
    void testItemsNotOverstockedDueToRateNotDividingIntoMaxNumExactly() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], maxStock, 2, 0);
    ...
    @Test
    void testItemsRestockedIfIntervalHasPast() throws CustomTraderDatabase.StockUpdateException, NoSuchFieldException, IllegalAccessException {
        Creature trader = factory.createNewCustomTrader();
        int time = 100;

        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], num, 1, 100);
    ...
    void testItemCorrectlyEnchanted() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, enchantments.values().toArray(new Enchantment[0]), num, num, num);
    ...
    void testFullyRestockUnique() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(trader, num, num, num, b, b, num, new Enchantment[0], num, 1, num);
    ...
    void testFullyRestockTag() throws CustomTraderDatabase.StockUpdateException {
        ...
        CustomTraderDatabase.addStockItemTo(tag, num, num, num, b, b, num, new Enchantment[0], num, 1, num);
        CustomTraderDatabase.fullyStock(trader);
